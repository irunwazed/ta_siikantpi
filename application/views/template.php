...
<body class="page-header-fixed">
      ...
      <div class="container-fluid">
        ...
        <li class="dropdown" id="header_inbox_bar">
          ...
          <li class="dropdown" id="header_inbox_bar">
            ...
            <?php
            $query = $this->db->query("select count(status) as stts from tbl_transaksi_header where status='0' or status='2'");
            foreach ($query->result_array() as $tampil) {
              $status = $tampil['stts'];
            }
            ?>
    ...
    <div class="page-sidebar nav-collapse collapse">
      ...
      <ul class="page-sidebar-menu">
        ...
        <li >
          ...
          <ul class="sub-menu">
            <li >
              <a href="<?php echo base_url();?>arsip/pemasar">
              Data Pengolah dan Pemasar Hasil Perikanan</a>
            </li>
        ...
        <li>
          ...
          <ul class="sub-menu">
            ...
            <!--  <li>
              <a href="<?php echo base_url();?>adminweb/sambutan">
              Sambutan
              </a>
            </li> -->
            <li>
  ...
  <div class="footer">
    <div class="footer-inner">
      2021 &copy; Informatika Untad - Admin Dashboard.
    </div>
