							...
							<div class="portlet-body form">
								...
								<div id="box" class="alert alert-success hide">
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea class="span12 wysihtml5 m-wrap" rows="20" name="deskripsi" id="deskripsi" value="<?php echo $deskripsi;?>" ><?php echo $deskripsi;?></textarea>
	...
	$(document).ready(function(){
		...
		$("#update").click(function(){
			...
			var deskripsi = $("#deskripsi").val();
	            	...
	            	$.ajax({
					type:"POST",
					url:"<?php echo base_url();?>adminweb/carabelanja_simpan",
