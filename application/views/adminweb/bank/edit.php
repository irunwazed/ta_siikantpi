							...
							<div class="portlet-body form">
								...
								<div id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="nama_bank" id="nama_bank" class="span6 m-wrap" value="<?php echo $nama_bank;?>" />
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="no_rekening" id="no_rekening" class="span6 m-wrap" value="<?php echo $no_rekening;?>" />
										</div>
									</div>
