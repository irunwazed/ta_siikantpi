							...
							<div class="portlet-body form">
								...
								<div id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="nama_nelayan" id="nama_nelayan" class="span6 m-wrap" placeholder="Nama Nelayan..." />
										</div>
									</div>

									<div class="control-group">
										<label class="control-label">No Hp Nelayan</label>
										<div class="controls">
											<input type="text" name="nelayan" id="nelayan" class="span6 m-wrap" placeholder="Nelayan..." value="62" />
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="date" name="tanggal" id="tanggal" class="span6 m-wrap" />
										</div>
									</div>
