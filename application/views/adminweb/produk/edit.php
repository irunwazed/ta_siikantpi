						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<div id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										<label class="control-label">Nama Pemasar</label>
										<div class="controls">
											<input type="text" name="nama_nelayan" id="nama_nelayan" class="span6 m-wrap" value="<?php echo $nama_nelayan;?>" />
										</div>
									</div>

									<div class="control-group">
										<label class="control-label">No Hp Pemasar</label>
										<div class="controls">
											<input type="text" name="nelayan" id="nelayan" class="span6 m-wrap" value="<?php echo $nelayan;?>" />
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="date" name="tanggal" id="tanggal" class="span6 m-wrap" value="<?php echo $tanggal;?>" />
										</div>
									</div>
